...
Подсказки,*/
let money_count = prompt("Введите сумму , которую хотите внести на счет");
let i = money_count.length;
//money_count.charAt(money_count.length - 1);
//alert(i);
if (money_count.charAt(i - 1) == 1 & money_count.charAt(i - 2) == 1) {
    alert("Зачислено на счет " + money_count + " рублей");
}
else {switch (money_count.charAt(i - 1)) {
        case "0":
            alert("Зачислено на счет " + money_count + " рублей");
            break;
        case "5":
            alert("Зачислено на счет " + money_count + " рублей");
            break;
        case "6": alert("Зачислено на счет " + money_count + " рублей");
            break;
        case "7": alert("Зачислено на счет " + money_count + " рублей");
            break;
        case "8": alert("Зачислено на счет " + money_count + " рублей");
            break;
        case "9": alert("Зачислено на счет " + money_count + " рублей");
            break;
        case "1":
            alert("Зачислено на счет " + money_count + " рубль");
            break;
        case "2":
            alert("Зачислено на счет " + money_count + " рубля");
            break;
        case "03":
            alert("Зачислено на счет " + money_count + " рубля");
            break;
